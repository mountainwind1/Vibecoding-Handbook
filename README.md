...
| 文件 | 作用 |
|------|------|
| [Vibe-Coding-正式项目工作手册v5.md](Vibe-Coding-正式项目工作手册v5.md) | 手册本体：阶段 0→4 全流程、9 条实战护栏（含双轨并行模式）、附录 A/B 角色提示词（入口是文末"一页速查"） |
...
```
读 Vibe-Coding-正式项目工作手册v5.md，把它当作审计标准，对本项目的执行过程做合规审核。
