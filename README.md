...
> 一套面向 Claude Code 的正式项目开发工作流（v5.2）：**垂直切片 + 任务分档 + 门禁收口 + 机制优先**。
...
| 文件 | 作用 |
|------|------|
| [Vibe-Coding-正式项目工作手册v5.2.md](Vibe-Coding-正式项目工作手册v5.2.md) | 手册本体：阶段 0→4 全流程（含 Phase 模式、文档规模化护栏）、9 条实战护栏、附录 A/B 角色提示词与支付集成检查单（入口是文末"一页速查"） |
...
```
读 Vibe-Coding-正式项目工作手册v5.2.md，把它当作审计标准，对本项目的执行过程做合规审核。
